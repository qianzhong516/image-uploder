...
const meta = {
    ...
    args: {
        imageItems: [
            ...
            { state: 'loading', title: 'Image2', totalSize: '330kb', progress: 50, imgSrc: '/avatar-image-item.png', onCancelUpload: fn() },
            { id: '3', state: 'load-success', title: 'Image3', totalSize: '400kb', imgSrc: '/avatar-image-item.png', onDelete: fn() },
            { state: 'error', title: 'Image4', totalSize: '200kb', error: 'This image is larger than 5MB. Please select a smaller image.', onDelete: fn() },
        ]
    },
